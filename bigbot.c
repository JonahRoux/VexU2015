...
#pragma config(Motor,  port1,           RIGHT_DRIVE,   tmotorVex393_HBridge, openLoop, encoderPort, I2C_2)
#pragma config(Motor,  port2,           RIGHT_DRIVE2,  tmotorVex393_MC29, openLoop, encoderPort, None)
...
#pragma config(Motor,  port7,           LEFT_DRIVE,    tmotorVex393_MC29, openLoop, encoderPort, I2C_4)
#pragma config(Motor,  port8,           LEFT_DRIVE2,   tmotorVex393_MC29, openLoop)
